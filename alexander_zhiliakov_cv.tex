...
\definecolor{minorclr}{RGB}{173, 173, 173} % \definecolor{bgclr}{RGB}{250, 250, 250}
\definecolor{bgclr}{RGB}{255, 255, 255} % \definecolor{bgclr}{RGB}{250, 250, 250}
%\pagecolor{bgclr}
...
\newcommand\xhrefd[3]{\href{#1}{#3\,``\myuline{#2}''}}
\newcommand\xhrefb[4]{\href{#1}{\myuline{#2}}#4\href{#1}{\myuline{#3}}}
\newcommand\xhrefbd[5]{\href{#1}{#5\,``\myuline{#2}}#4\href{#1}{\myuline{#3}''}}
...
%\newcommand\myrefs{\textcolor{minorclr}{References:}}
%\newcommand\at{\textcolor{minclr}{@}}
...
\begin{document}
	...
	\begin{longtable}{>{\raggedleft\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{14.5cm}}
		...
		Summary:
			...
			%		\multicolumn{2}{p{17cm}}{My scientific contributions can be found on~\xhref{https://www.researchgate.net/profile/Alexander_Zhiliakov}{ResearchGate} and \xhref{https://scholar.google.com/citations?user=wchxEFUAAAAJ}{Google Scholar}. Some of my code contributions are available on \xhref{https://github.com/56thclr}{GitHub}. I ask and answer questions on scientific computing on~\xhref{https://scicomp.stackexchange.com/users/21916/56thclr}{SciComp}}
		Languages:		
	...
	\begin{etaremune}[topsep=0pt]
		\item 
			\xhrefd{https://u.pcloud.link/publink/show?code=XZ0wHFVZ1EUibC0Nw9jJPXS80JX7pJU3fVi7}{Trace finite element method for material surface flows}{{\small\faCloudDownload*}}\\
			\me\\ 
			PhD dissertation, May~2022
		\item 
			\xhrefd{https://arxiv.org/abs/2203.01521}{Tangential Navier--Stokes equations on evolving surfaces: Analysis and simulations}{\faFilePdf}\\
			M.~Olshanskii, A.~Reusken, \me\\
			\xhref{https://doi.org/10.48550/arXiv.2203.01521}{arXiv preprint}, Mar~2022
		\item 
			\xhrefbd{https://arxiv.org/abs/2104.08996}{A decoupled, stable, and linear FEM for a phase-field model of variable density two-phase}{incompressible surface flow}{\\}{\faFilePdf}\\
			Y.~Palzhanov, \me, A.~Quaini, M.~Olshanskii\\
			\xhref{https://doi.org/10.1016/j.cma.2021.114167}{Computer Methods in Applied Mechanics \& Engineering}, Oct~2021
		\item 
			\xhrefd{https://arxiv.org/abs/2012.10073}{Recycling augmented Lagrangian preconditioner in an incompressible fluid solver}{\faFilePdf}\\ M.~Olshanskii, \me\\ \xhref{https://doi.org/10.1002/nla.2415}{Numerical Linear Algebra with Applications}, Oct~2021
		\item 
			\xhrefd{https://arxiv.org/abs/2003.06972}{Error analysis of higher order trace finite element methods for the surface Stokes equations}{\faFilePdf}\\
			T.~Junkuhn, M.~Olshanskii, A.~Reusken, \me\\ 
			\xhref{https://doi.org/10.1515/jnma-2020-0017}{Journal of Numerical Mathematics}, Sep~2021	
		\item 
			\xhrefd{https://arxiv.org/abs/1909.02990}{Inf-sup stability of the trace $\mathbf P_2$--$P_1$ Taylor--Hood elements for surface PDEs}{\faFilePdf}\\
			M.~Olshanskii, A.~Reusken, \me\\ 
			\xhref{https://doi.org/10.1090/mcom/3551}{AMS: Mathematics of Computation}, Mar~2021	
		\item 
  			\xhrefbd{https://arxiv.org/abs/2006.14125}{Experimental validation of a phase-field model to predict coarsening dynamics of lipid doma-}{ins in multicomponent membranes}{\\}{\faFilePdf}\\
  			\me, Y.~Wang, A.~Quaini, M.~Olshanskii, S.~Majd\\
			\xhref{https://doi.org/10.1016/j.bbamem.2020.183446}{Biochimica et Biophysica Acta}, Aug~2020
		\item
			\xhrefd{https://www.researchgate.net/publication/333900759_A_higher_order_approximate_static_condensation_method_for_multi-material_diffusion_problems}{A higher order approximate static condensation method for multi-material diffusion problems}{\faResearchgate}\\
			\me, D.~Svyatsky, M.~Olshanskii, E.~Kikinzon, M.~Shashkov\\ 
			\xhref{https://doi.org/10.1016/j.jcp.2019.06.044}{Journal of Computational Physics}, Jun~2019\\ \xhref{https://permalink.lanl.gov/object/tr?what=info:lanl-repo/lareport/LA-UR-18-31169}{LANL report LA-UR-18-31169}, Nov~2018 
		\item
			\xhrefbd{https://www.researchgate.net/publication/318039077_Postroenie_i_realizacia_fiziceskih_pereobuslavlivatelej_dla_zadac_vycislitelnoj_gemodinamiki}{Construction and implementation of physics-based preconditioners for problems of computa-}{tional haemodynamics}{\\}{\faResearchgate}\\
			\me\\ 
	...
	\subsubsection*{\xhrefd{https://u.pcloud.link/publink/show?code=XZ699FVZ2RBot5dbf55v89OJRgiuPuHnGhY7}{Unfitted finite element methods for fluid flows on surfaces}{{\small\faCloudDownload*}}}
	...
	\begin{etaremune}[topsep=0pt]
		\item
			\xhrefd{https://www.math.uh.edu/~dlabate/LectureNote_03.pdf}{Non-linear support vector machines}{\faFilePdf} (joint work with S.~Oyeleye)\\
			Lecture notes for ``Mathematics of Machine Learning'' class taught by Prof. D.~Labate, Feb~2020 
		\item 
			\xhrefd{https://www.researchgate.net/publication/338009857_Matrix-free_finite_element_method}{Matrix-free finite element method}{\faResearchgate} (joint work with K.~Williams)\\ 
			Final project for ``Introduction to high-performance computing'' class taught by Prof. L.~Johnsson, 10 Dec~2019
		\item
			\xhrefd{https://www.researchgate.net/publication/338011181_Multigrid_techniques_for_elliptic_and_not-that-elliptic_problems}{Multigrid techniques for elliptic and not-that-elliptic problems}{\faResearchgate}\\
			Presentation for ``Multigrid \& domain decomposition methods'' class taught by Prof. M.~Olshanskii, 22 Apr~2019
		\item
			\xhrefd{https://www.researchgate.net/publication/321334354_Anderson's_mixing_for_nonlinear_magnetostatic_Poisson_problem}{Anderson's mixing for nonlinear magnetostatic Poisson problem}{\faResearchgate}\\
	...
	\end{longtable}
%	\vfill
%	\centering\small\color{minorclr}\today$\:\cdot\:$\xurl{https://www.math.uh.edu/~alex/alexander_zhiliakov_cv.pdf}	
\end{document} 