...
\begin{document}
	...
	\begin{longtable}{ l >{\raggedright\arraybackslash}p{15cm} }
		...
		Major skills:	& Scientific computing, applied mathematics, numerical analysis, (unfitted) finite element methods, preconditioners, computational fluid dynamics, computational haemodynamics, Unix\,/\,Windows, git, HPC (slurm, PAPI\,/\,TAU, OpenMP), cmake, \texttt{C++\,11\,/\,17}, \texttt{FORTRAN}, \texttt{Wolfram Mathematica}\vspace{2mm}\\
