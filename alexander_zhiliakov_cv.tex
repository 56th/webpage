...
\begin{document}
	...
	\begin{longtable}{ l >{\raggedright\arraybackslash}p{15cm} }
		...
		Major skills:	& Scientific computing, applied mathematics, numerical analysis, (unfitted) finite element methods, preconditioners, computational fluid dynamics, computational haemodynamics, Unix\,/\,Windows, HPC, git, cmake, \texttt{C++11\,/\,17}, \texttt{FORTRAN}, \texttt{Wolfram Mathematica}\vspace{2mm}\\
...
%			& Contacts: Marina Persova \href{mailto:persova@ami.nstu.ru}{persova@ami.nstu.ru} (advisor)\vspace{3mm}\\
	...
	\begin{etaremune}[topsep=0pt]
		...
		\item \textit{\href{}{Inf-sup stability of the trace $\mathbf P_2$\,--\,$P_1$ Taylor\,--\,Hood elements for surface PDEs}}, M. Olshanskii, A. Reusken, A. Zhiliakov\\ \href{}{arXiv preprint}, September 2019 
...
%		\end{itemize}
	...
	\begin{longtable}{ l >{\raggedright\arraybackslash}p{15cm} }
		...
		\href{https://github.com/CATSPDEs/}{CATS'\,PDEs}
			& Modern OOP toolkit for efficient implementation of typical FEM~routines (\texttt{C++11\,/\,17}, \texttt{FORTRAN}, and \texttt{Mathematica})\vspace{1mm}\\
