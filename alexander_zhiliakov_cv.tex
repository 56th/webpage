...
\begin{document}
	...
	\begin{longtable}{ l >{\raggedright\arraybackslash}p{15cm} }
		...
		Spring 2020
			& (1)~Modeling evolving fluidic interfaces with \href{https://www.math.uh.edu/~molshan/tracefinite.html}{trace FEM} discretization of (Navier--)Stokes equations posed on a surface; (2)~Numerical simulation of material surfaces (details TBA)\vspace{1mm}\\
		Fall 2019
...
%		\end{itemize}
	...
	\begin{etaremune}[topsep=0pt]
		\item \href{https://www.siam.org/Conferences/CM/Main/gs19}{SIAM Conference on Mathematical \& Computational Issues in the Geosciences}, Houston, TX, 12 Mar 2019\\
		...
		\item \href{https://www.siam.org/Conferences/CM/Main/txla18}{SIAM Louisiana-Texas Section Conference}, Baton Rouge, LA, 7 Oct 2018\\
		      Talk: \textit{Generalized approximate static condensation method for a heterogeneous multi-material diffusion problem}
		\item \href{https://ami.nstu.ru/o-fakultete/news/1699/}{FAMCS NSTU Student Scientific Conference} on Numerical Modeling in Physics, Novosibirsk, Russia, Mar 2017\\
